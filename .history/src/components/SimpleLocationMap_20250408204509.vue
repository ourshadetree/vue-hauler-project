...
async function initMap() {
  ...
  // Initialize autocomplete for lookup and routing inputs if tools are expanded.
  await nextTick()
...
// Refresh the map: recenter, reset zoom, reload station data, re-create markers, clear route and close info window.
