...
async function initMap() {
  ...
  // Create the map with standard controls removed.
...
async function geocodeAddress(address) {
  const apiKey = 'AIzaSyDYpNJXRFRuQq5IV8LQZi8E90r1gIaiORI' // Replace this with your actual key.
...
// Refresh the map: recenter, reset zoom, reload station data and markers, clear route and info window.
