<template>
  <div id="app">
    ...
    <div id="bannerBox">
      <img alt="haulerBanner" id="banner" src="../src/assets/finalLogoBanner.png" />
    </div>
...
nav {
  ...
  height: 100%;
  padding-top: 90px; /* Space for banner, if you want extra top padding */
...
#pageContent {
  ...
  padding-top: 50px;  /* same height as banner */
  padding: 20px;
