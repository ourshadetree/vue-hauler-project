<template>
  <div class="profile-view">
    ...
    <!-- 4) Form is always in the DOM, but hidden under the loading flag -->
...
onMounted(async () => {
  ...
  try {
    ...
    // 2) Always try to fetch their profile row (even if user is null
    //    this will return PGRST116 and we'll ignore it)
    if (user?.id) {
