<template>
  <div class="profile-view">
    ...
    <div v-if="!registrationComplete" class="complete-step">
      <button class="complete-btn" @click="completeRegistration">
    ...
    <div v-else>
      <div class="form-header">
        <h2>Your Profile</h2>
        <!-- only show Edit Info when not already editing -->
      ...
      <form v-else @submit.prevent="saveProfile">
        ...
        <!-- only show Save when in edit mode -->
        <button v-if="editing" type="submit" class="save-btn">
          Save
        </button>
      </form>
    </div>
...
onMounted(async () => {
  ...
  try {
    ...
    // 3) if we didn’t have an email in profile, default to auth email
