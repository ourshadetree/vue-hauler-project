  ...
  <div id="fuelToolsContainer">
    ...
    <div class="tools-nav">
      <div class="tools-links">
        <div
          :class="['tab-link', { active: activeTab === 'home' }]"
      ...
      <div v-if="activeTab === 'home'" class="tab-placeholder">
        <FuelHome />
...
import NearbyStationList from "@/components/StationList.vue";
import FuelHome from "@/components/FuelHome.vue"; // Importing the FuelHome component
import { ref } from 'vue';
...
export default {
  ...
  data() {
    ...
    updateFilteredStations(payload) {
      // Expect payload to be an object: { stations: [...], reference: { lat, lng } }
      console.log("Received filtered payload:", payload); // Debug log
      this.filteredStations = payload.stations || [];
      this.currentReference = payload.reference || null;
    },
  }
